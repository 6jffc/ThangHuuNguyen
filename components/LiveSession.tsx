  ...
  return (
    <div className="h-full flex items-center justify-center p-6 bg-white">
       <div className="max-w-lg w-full text-center">
          ...
          <div className="mb-10">
              <h2 className="text-3xl font-bold text-gray-900 mb-2 font-sans">Live Nexus</h2>
              <p className="text-gray-500 font-serif italic">Real-time conversational audio interface.</p>
          </div>

          <div className="flex flex-col items-center justify-center min-h-[200px] border border-gray-200 rounded-xl bg-gray-50 p-8 shadow-sm">
              <div className={`w-24 h-24 rounded-full flex items-center justify-center mb-6 transition-all duration-300 border-2 ${
                  active ? 'border-academic-accent bg-blue-50' : 'border-gray-300 bg-white'
              }`}>
                  {status === 'connecting' ? (
                      ...
                      <i className="fas fa-microphone text-2xl text-gray-400"></i>
                  )}
              </div>

              <p className="text-gray-600 font-sans font-medium mb-6">
